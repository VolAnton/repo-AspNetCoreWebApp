...
{
    public sealed class PersonRepository : List<Person>
    {
        private List<Person> _data;

        public List<Person> Data { get => _data; set => _data = value; }
        ...
        public PersonRepository()
        {
            Data = new List<Person>()
            {
                ...
                new Person { Id = 16, FirstName = "Vincent", LastName = "Fox", Email = "faucibus.Morbi.vehicula@ipsumdolor.edu", Company = "Imperdiet Dictum MagnaFoundation", Age = 54 },
